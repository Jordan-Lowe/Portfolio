    ...
    return knex('languageInfoTBL')
      ...
      .then(function () {
        ...
        return knex('languageInfoTBL').insert([
          ...
          {
            id: 2,
            language_name: 'Past Project Pinky Promise',
            language_info: `During the final week at Dev Academy, I collaborated with a team
            ...
            audience of approximately 70 people. 
            We embraced Agile methodologies to manage our project
            effectively. Each day began with a stand-up meeting
            ...
            eagerness to broaden my technical skills.
